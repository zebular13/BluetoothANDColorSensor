...
//set the threshhold had which sensor senses color
#define CLEARTHRESHOLD 30
...
void loop() {
    ...
    if (buttonState == HIGH) { 
      ...
      //if it is, write the values that the color sensor is sensing
  ...
  if ( Serial1.available()){
      ...
      //if there's no data being sent, treat it as invalid and flush the buffer.
      Serial1.flush();
    }
  } 
